...
from app.models.database import User, Message, Event, ProcessedImage, Subscription, CreditTransaction, UsageLog, Transaction, UserFeedback, ShareEvent, UserStats, PremiumUsageTracking
import logging
...
async def init_db():
    ...
    await init_beanie(
        ...
        document_models=[User, Message, Event, ProcessedImage, Subscription, CreditTransaction, UsageLog, Transaction, UserFeedback, ShareEvent, UserStats, PremiumUsageTracking]
    )
